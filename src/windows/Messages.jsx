...
const Messages = ({ windowKey }) => {
    ...
    return (
        <div className="w-full h-full flex bg-transparent overflow-hidden rounded-xl shadow-2xl relative">
            {/* Sidebar */}
            <div className="w-[220px] shrink-0 border-r border-white/10 bg-[#252525]/95 backdrop-blur-3xl flex flex-col h-full z-20">
                ...
                <div className="p-3">
                    <div className="flex items-center gap-2 p-2 rounded-md bg-[#2d5be3]/80 text-white cursor-default drop-shadow-md">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-cyan-400 to-blue-500 flex items-center justify-center shadow-inner shrink-0">
            ...
            {/* Chat Area */}
            <div className="flex-1 flex flex-col bg-[#1e1e1e]/90 backdrop-blur-3xl relative min-w-0 h-full overflow-hidden">
                <div className="h-12 border-b border-white/10 flex items-center px-6 shrink-0 bg-white/5 backdrop-blur-md z-10 w-full">
                ...
                <div className="p-4 bg-transparent shrink-0 w-full border-t border-white/5 z-10">
                    <form onSubmit={handleSend} className="relative flex items-center w-full">
                        ...
                        <button 
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center disabled:opacity-50 disabled:bg-gray-600 transition-colors shrink-0"
                        >
